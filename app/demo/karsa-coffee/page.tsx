...
export default function KarsaCoffeePage() {
  return (
    <main className="kc-page">
      ...
      <section className="kc-membership kc-wrap"><div><p>Teman Karsa</p><h2>Setiap cangkir<br />punya <em>cerita baru.</em></h2><p>Kumpulkan stempel, nikmati menu rahasia, dan dapatkan undangan lebih awal untuk cupping session kami.</p><a href="mailto:hello@naltech.id">Gabung komunitas <span>↗</span></a></div><div className="kc-card"><span>K</span><small>KARSA COFFEE CLUB</small><strong>GOOD COFFEE<br />GOOD COMPANY</strong><p>MEMBER · 00128</p><i>✦</i></div></section>

      <section id="visit" className="kc-visit">
        <div className="kc-wrap"><header><p><span>05</span> Datang & berjumpa</p><h2>Satu meja<br />menunggumu.</h2></header><div className="kc-visit-info"><article><small>Alamat</small><p>Jl. Kemang Raya No. 21<br />Jakarta Selatan 12730</p><a href="https://maps.google.com" target="_blank" rel="noreferrer">Buka peta ↗</a></article><article><small>Jam buka</small><p>Senin—Jumat · 07.00—22.00<br />Sabtu—Minggu · 08.00—23.00</p></article><article><small>Kontak</small><p>hello@karsacoffee.id<br />+62 812 3456 7890</p><a href="mailto:hello@naltech.id">Reservasi meja ↗</a></article></div></div>
      </section>

      <footer className="kc-footer kc-wrap"><a className="kc-logo" href="#top"><span>K</span>KARSA</a><p>Specialty coffee, warm space,<br />and stories worth sharing.</p><div><a href="#menu">Menu</a><a href="#story">Cerita</a><a href="#space">Kedai</a><a href="#visit">Kunjungi</a></div><div><a href="/">Portfolio Naltech</a><a href="mailto:hello@naltech.id">Buat project serupa</a></div><small>© 2026 Karsa Coffee · Concept website by Naltech Studio · Bukan kedai aktif</small></footer>
    </main>
  );
}
